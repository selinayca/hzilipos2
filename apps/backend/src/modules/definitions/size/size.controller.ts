...
@ApiTags('Definitions — Sizes') @ApiBearerAuth() @UseGuards(JwtAuthGuard) @Controller('definitions/sizes')
export class SizeController {
  constructor(private readonly svc: SizeService) {}
  ...
  @Post()   create(@CurrentTenant() t: Tenant, @Body() dto: CreateSizeDto) { return this.svc.create(t.id, dto); }
  @Patch(':id') update(@CurrentTenant() t: Tenant, @Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateSizeDto) { return this.svc.update(t.id, id, dto); }
